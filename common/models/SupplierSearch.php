...
class SupplierSearch extends Supplier
{
    ...
    {
        return [
            [['id', 'business_number_of_year', 'supplier_type_id', 'legal_structure_id', 'primary_commodity_id'], 'integer'],
            [['name', 'email', 'website', 'contact_person', 'timestamp', 'principal_name', 'principal_title', 'description', 'barangay_id'], 'safe'],
        ];
    }
